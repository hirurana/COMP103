...
//USE THESE INSTEAD OF THE DB WHEN USING ANY FUNCTION OTHER THAN THE LOADPROJECTS FUNCTION
var users = {
   _id : "hrana90",
   projectIDs : [ "6f404e57-4407-4849-bec3-689ef714a206", "12b1ac1f-cf6c-4919-bd25-1cd9dd918b75", "9ad6719c-68e2-4457-baa6-2de720fe3cc6", "8190f86b-12e4-4e9a-a0af-f4e0b03b813e" ] }
}

var projects = { _id : "6f404e57-4407-4849-bec3-689ef714a206", data : { projectName : "Project 1", projectManager : "Bob Rana", managerNum : "+447912345678", email : "bob.smith.17@st-andrews.ac.uk", teamMembers : "John Doe, Sanjay", budget : 1300, approverEmail : "hiru.ranasinghe.17@ucl.ac.uk", checkboxData : {  }, videoURL : "" } }
{ _id : "12b1ac1f-cf6c-4919-bd25-1cd9dd918b75", data : { projectName : "Project 2", projectManager : "Johnny Doe", managerNum : "+447912345678", email : "john.bob.14@ucl.ac.uk", teamMembers : "John Man, Dan Smith", budget : 1500, approverEmail : "hiru.sdf.17@ucl.ac.uk", checkboxData : {  }, videoURL : "" } }
{ _id : "9ad6719c-68e2-4457-baa6-2de720fe3cc6", data : { projectName : "Untitled", projectManager : "", managerNum : "", email : "", teamMembers : "", budget : 0, approverEmail : "", checkboxData : {  }, videoURL : "" } }
{ _id : "8190f86b-12e4-4e9a-a0af-f4e0b03b813e", data : { projectName : "Untitled", projectManager : "", managerNum : "", email : "", teamMembers : "", budget : 0, approverEmail : "", checkboxData : {  }, videoURL : "" } }
...
exports.sendEmail = (approverEmail, projectManager, url, pmEmail) => {
  var transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      // TODO: Create email and fill in
      user: '',
      pass: ''
    }
  });
